🧬 PrimersQuest Pro
PrimersQuest Pro is a free, web-based qPCR primer design tool built with Streamlit. It combines the Primer3 thermodynamic engine with Harvard PrimerBank integration, interactive visualisations, and NCBI Primer-BLAST validation links — all in a single Python script.
...
Select your fork, set the main file to prime6.py, and click Deploy.

No additional configuration is required — all dependencies are specified in requirements.txt.

🔗 External Resources
NCBI Primer-BLAST — specificity validation

Harvard PrimerBank — curated qPCR primer database

Primer3 — underlying thermodynamic design engine
